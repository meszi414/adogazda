...
const VerticalFeatures = () => (
  ...
  >
    ...
    <VerticalFeatureRow
      ...
      image={`${process.env.PUBLIC_URL}/assets/images/acc1.jpg`}
    ...
    <VerticalFeatureRow
      ...
      image={`${process.env.PUBLIC_URL}/assets/images/tax1.jpg`}
    ...
    <VerticalFeatureRow
      ...
      image={`${process.env.PUBLIC_URL}/assets/images/audit1.jpg`}
